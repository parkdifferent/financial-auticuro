...
public final class TransferServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.auticuro.proto.TransferService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.auticuro.proto.TransferRequest,
      com.auticuro.proto.TransferResponse> getTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Transfer",
      requestType = com.auticuro.proto.TransferRequest.class,
      responseType = com.auticuro.proto.TransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.auticuro.proto.TransferRequest,
      com.auticuro.proto.TransferResponse> getTransferMethod() {
    io.grpc.MethodDescriptor<com.auticuro.proto.TransferRequest, com.auticuro.proto.TransferResponse> getTransferMethod;
      ...
      synchronized (TransferServiceGrpc.class) {
        if ((getTransferMethod = TransferServiceGrpc.getTransferMethod) == null) {
          TransferServiceGrpc.getTransferMethod = getTransferMethod =
              io.grpc.MethodDescriptor.<com.auticuro.proto.TransferRequest, com.auticuro.proto.TransferResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.auticuro.proto.BatchTransferRequest,
      com.auticuro.proto.BatchTransferResponse> getBatchTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "BatchTransfer",
      requestType = com.auticuro.proto.BatchTransferRequest.class,
      responseType = com.auticuro.proto.BatchTransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.auticuro.proto.BatchTransferRequest,
      com.auticuro.proto.BatchTransferResponse> getBatchTransferMethod() {
    io.grpc.MethodDescriptor<com.auticuro.proto.BatchTransferRequest, com.auticuro.proto.BatchTransferResponse> getBatchTransferMethod;
    if ((getBatchTransferMethod = TransferServiceGrpc.getBatchTransferMethod) == null) {
      synchronized (TransferServiceGrpc.class) {
        if ((getBatchTransferMethod = TransferServiceGrpc.getBatchTransferMethod) == null) {
          TransferServiceGrpc.getBatchTransferMethod = getBatchTransferMethod =
              io.grpc.MethodDescriptor.<com.auticuro.proto.BatchTransferRequest, com.auticuro.proto.BatchTransferResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "BatchTransfer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.auticuro.proto.BatchTransferRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.auticuro.proto.BatchTransferResponse.getDefaultInstance()))
              .setSchemaDescriptor(new TransferServiceMethodDescriptorSupplier("BatchTransfer"))
              .build();
        }
      }
    }
    return getBatchTransferMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void transfer(com.auticuro.proto.TransferRequest request,
        io.grpc.stub.StreamObserver<com.auticuro.proto.TransferResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getTransferMethod(), responseObserver);
    }

    /**
     */
    default void batchTransfer(com.auticuro.proto.BatchTransferRequest request,
        io.grpc.stub.StreamObserver<com.auticuro.proto.BatchTransferResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getBatchTransferMethod(), responseObserver);
    }
  }
  ...
  public static final class TransferServiceStub
    ...
    /**
     */
    public void transfer(com.auticuro.proto.TransferRequest request,
        io.grpc.stub.StreamObserver<com.auticuro.proto.TransferResponse> responseObserver) {
    ...
    /**
     */
    public void batchTransfer(com.auticuro.proto.BatchTransferRequest request,
        io.grpc.stub.StreamObserver<com.auticuro.proto.BatchTransferResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getBatchTransferMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class TransferServiceBlockingStub
    ...
    /**
     */
    public com.auticuro.proto.TransferResponse transfer(com.auticuro.proto.TransferRequest request) {
    ...
    /**
     */
    public com.auticuro.proto.BatchTransferResponse batchTransfer(com.auticuro.proto.BatchTransferRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getBatchTransferMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class TransferServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.auticuro.proto.TransferResponse> transfer(
        com.auticuro.proto.TransferRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.auticuro.proto.BatchTransferResponse> batchTransfer(
        com.auticuro.proto.BatchTransferRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getBatchTransferMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_TRANSFER = 0;
  private static final int METHODID_BATCH_TRANSFER = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TRANSFER:
          serviceImpl.transfer((com.auticuro.proto.TransferRequest) request,
              (io.grpc.stub.StreamObserver<com.auticuro.proto.TransferResponse>) responseObserver);
          break;
        case METHODID_BATCH_TRANSFER:
          serviceImpl.batchTransfer((com.auticuro.proto.BatchTransferRequest) request,
              (io.grpc.stub.StreamObserver<com.auticuro.proto.BatchTransferResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.auticuro.proto.TransferRequest,
              com.auticuro.proto.TransferResponse>(
                service, METHODID_TRANSFER)))
        .addMethod(
          getBatchTransferMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.auticuro.proto.BatchTransferRequest,
              com.auticuro.proto.BatchTransferResponse>(
                service, METHODID_BATCH_TRANSFER)))
        .build();
  }
      ...
      synchronized (TransferServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getBatchTransferMethod())
              .build();
        }
      }
    }
